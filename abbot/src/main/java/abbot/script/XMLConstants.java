...
/**
 * Attributes used by script steps and component references.  Any entries here should have a corresponding entry to the
...
public interface XMLConstants {
  ...
  /**
   * Title of a Frame, Dialog or JInternalFrame.  Any other use is deprecated (i.e. Title of window ancestor).
   */
