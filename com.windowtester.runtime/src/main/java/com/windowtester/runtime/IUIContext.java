...
/**
 * The main point of entry for interaction with the UI during test playback.
 * <p>
...
public interface IUIContext {
  ...
  /**
   * Click the given component, identified by locator. This is fully equivalent to
   * <pre>
  ...
  /**
   * Click the given component, identified by locator. See {@link #click(ILocator)} for examples
   *
   * @param clickCount   the number of times the widget should be clicked
   * @param locator      the locator identifying where the click should occur
   ...
   * @return the clicked widget
   */
  IWidgetLocator click(int clickCount, ILocator locator, int modifierMask)
      throws WidgetSearchException;

  /**
   * Context click the given widget and select the menu item described by this path. For example:
   * <pre>
   * 		ui.contextClick(
   ...
   * <p>
   * Composite key clicks can be specified by bitwise or-ing  key constants. For example:
   *
