 ...
 * </pre>
 * would generate such an exception because a tree item cannot be the child of a Combo.
 */
public class IncompatibleTypeException extends IllegalStateException {
  ...
  /**
   * Constructs an IncompatibleTypeException with the specified detail message.  A detail message is
